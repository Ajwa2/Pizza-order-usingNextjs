    ...
    return (
        <div>
            <div className="flex justify-between py-10 px-10 bg-footer">
                <nav className="flex gap-10 text-black font-bold pt-11">
                ...
                <div>
                    ...
                    <div className="flex bg-white rounded-xl p-2">
                        <input 
                            ...
                            className="flex-1 outline-none w-72 text-sm pl-2"
                        />
            ...
            <div className="flex justify-between bg-black text-white px-10 py-4">
                <div className="text-gray-300">
                    <p className="flex gap-5"><small>2024PizzaAllRightsReseverd</small><small>Terms & conditions</small></p>
                </div>
